    ...
    <div className=" max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className=" flex items-center">
        ...
        <h1 className=" text-xl sm:text-2xl lg:text-3xl px-2">
          Foody<span className=" font-bold">Doody</span>
        </h1>
      ...
      {/*Scarch input */}
      <div className=" bg-gray-300 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:[500px]">
        <AiOutlineSearch size={20} />
        <input
          className=" bg-transparent p-2 focus:outline-none"
          type="text"
          placeholder="Scarch Food"
          id=""
        />
      </div>
      {/*Cart button */}
